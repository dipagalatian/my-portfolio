        ...
        <div id="about" className="bg-[#121121] pb-[3rem] pt-[4rem] md:pt-[8rem]">
            <div className="grid grid-cols-1 md:grid-cols-2 w-[80%] mx-auto gap-[3rem] items-center">
                <div>
                    ...
                    <h2
                        className="text-[25px] md:text-[35px] lg:text-[45px] md:leading-[3rem] leading-[2rem] capitalize
                    ...
                    <div className="mb-[3rem] flex items-center md:space-x-10">
                        ...
                        <p className="text[19px] text-slate-300 w-[80%] text-justify">
                            My name is Parar Tria Dipa G and I build things for the web. <br />
                            After graduating from college, I decided to pursue a career in technology and tried to get really good at it by joining a coding bootcamp as a fullstack developer.
                        </p>
                    </div>
                    <button
                    ...
                    >
                        <Link href="/creative_cv.pdf" target="_blank">
                            Creative CV
                        </Link>
