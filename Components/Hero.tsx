            ...
            <div className="w-[80%] grid-cols-1 mx-auto grid lg:grid-cols-2 gap-[3rem] h-[100%] items-center">
                <div>
                    ...
                    <p className="text-[#ffffff92] mt-[1.5rem] text-[18px]">
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Accusantium ipsa expedita molestias, eveniet praesentium iste veritatis sequi quia. Fugit inventore quasi veniam ipsam dolorum placeat?
                    </p>
                ...
                <div className="w-[500px] hidden bg-[#55e6a5] relative lg:flex items-center rounded-full h-[500px] ">
                    <Image src="/images/u1.jpg" alt="photo" layout="fill" className="object-cover rounded-full" />
                </div>
            </div>
        </div>
    );
